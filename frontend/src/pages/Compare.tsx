...
const GlowButton = ({ children, onClick, variant = "primary", className = "", disabled = false }: {
    ...
    const variants = {
        primary: "bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 text-white shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/30 hover:-translate-y-0.5",
    ...
    <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full">
            ...
            <motion.div
                ...
                className="absolute top-1/2 right-1/4 w-80 h-80 bg-gradient-to-br from-purple-400/20 to-fuchsia-600/20 rounded-full blur-3xl"
            />
            <motion.div
                animate={{ x: [0, 60, 0], y: [0, -80, 0] }}
                transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
                className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-gradient-to-br from-fuchsia-400/20 to-violet-400/20 rounded-full blur-3xl"
            />
        </div>
                ...
                >
                    <div className="text-center mb-12">
                        <motion.div
                            ...
                            className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-violet-500 via-purple-500 to-fuchsia-600 rounded-3xl shadow-2xl shadow-purple-500/30 mb-8 relative"
                        >
                            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-white/20 to-transparent" />
                            <Users className="w-10 h-10 text-white relative z-10" />
                            <motion.div
                                className="absolute -inset-2 rounded-3xl bg-gradient-to-br from-violet-500/20 to-purple-500/20 blur-xl"
                        ...
                        >
                            <span className="bg-gradient-to-r from-gray-900 via-violet-800 to-purple-800 dark:from-white dark:via-violet-200 dark:to-purple-200 bg-clip-text text-transparent">
                                简历对比分析
                            </span>
                        </motion.h1>
                        <motion.p
                        ...
                        >
                            ...
                            <span className="text-purple-600 dark:text-purple-400 font-medium">AI 驱动的智能招聘决策</span>
                        </motion.p>
                    </div>
                                            ...
                                            <div className="relative p-1 bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl rounded-2xl border border-gray-200/50 dark:border-gray-700/50 shadow-lg shadow-gray-900/5">
                                                <motion.div
                                                    ...
                                                    style={{
                                                        ...
                                                        width: 'calc(50% - 4px)',
                                                        background: useCoze
                                                            ? 'linear-gradient(to right, #c084fc, #e9d5ff)'
                                                    ...
                                                    <div className="grid md:grid-cols-2 gap-6">
                                                        <div>
                                                            ...
                                                            <textarea
                                                                ...
                                                                className="w-full p-3 border border-gray-200/50 dark:border-gray-600/50 rounded-xl bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm text-gray-900 dark:text-white resize-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-300 transition-all"
                                                                rows={3}
                                                            />
                                                        </div>
                                                        <div>
                                ...
                                <div className="flex items-center justify-between mb-10">
                                    <div className="flex items-center space-x-5">
                                        <motion.div
                                            ...
                                            className="w-14 h-14 bg-gradient-to-br from-violet-400 to-purple-500 rounded-2xl flex items-center justify-center shadow-xl shadow-purple-500/30 relative"
                                        >
                                            <CheckCircle className="w-7 h-7 text-white" />
                                            <motion.div
                                                className="absolute -inset-1 rounded-2xl bg-purple-500/20 blur-md"
                                ...
                                <div className="grid lg:grid-cols-3 gap-6 mb-8">
                                    {comparisonResult.resumes.map((resume, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <GlassCard className={`p-6 h-full ${isWinner ? 'ring-2 ring-purple-400/30' : ''}`}>
                                                    <div className="flex items-center justify-between mb-4">
                                                    ...
                                                    <div key={idx} className="flex items-center space-x-3">
                                                        ...
                                                        <div className="flex-1 h-3 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                                                            <motion.div
                                                                ...
                                                                className={`h-full rounded-full ${idx === 0 ? 'from-violet-500 to-purple-500' : idx === 1 ? 'from-fuchsia-500 to-pink-500' : idx === 2 ? 'from-purple-500 to-violet-500' : idx === 3 ? 'from-pink-500 to-rose-500' : 'from-rose-500 to-red-500'}`}
                                                                style={{
                                    ...
                                    <GlassCard className="p-6" delay={0.3}>
                                        ...
                                        >
                                            <div className="flex items-center space-x-2">
                                                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-violet-400 to-purple-600 flex items-center justify-center shadow-md shadow-purple-500/20">
                                                        ...
                                                        {result.skillsDetails.matched.length > 0 && (
                                                            <div className="mt-2 flex flex-wrap gap-1">
                                                                {result.skillsDetails.matched.slice(0, 5).map((skill, i) => (
                                                                    <span key={i} className="px-2 py-1 bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300 text-xs rounded-full">
                                                                        {skill.name}
                                                                    </span>
                                                                ))}
                                                            </div>
                                    ...
                                    {comparisonResult.resumes.map((resume, index) => (
                                        <div key={resume.id} className="space-y-4">
                                            ...
                                            {comparisonResult.results && comparisonResult.results[index].highlights.length > 0 && (
                                                <div className="backdrop-blur-xl bg-purple-50/60 dark:bg-purple-900/20 border border-purple-200/50 dark:border-purple-800/30 rounded-2xl p-4 hover:shadow-md hover:shadow-purple-500/5 transition-all duration-300">
                                                    <h5 className="text-sm font-semibold text-purple-800 dark:text-purple-300 mb-3 flex items-center space-x-2">
