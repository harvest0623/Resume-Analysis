        ...
        >
          <div className="text-center mb-12">
            <div className="inline-flex items-center px-4 py-2 bg-purple-50 border border-purple-200 rounded-full mb-4">
              ...
              <span className="text-sm font-medium text-purple-700">AI 驱动</span>
            </div>
                    ...
                    <div className="flex items-center justify-between mb-8">
                      ...
                      <div className="flex items-center space-x-3">
                        <button
                          ...
                          className="inline-flex items-center space-x-2 px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-xl transition-colors"
                        >
                          <RefreshCcw className="w-4 h-4" />
                          <span>重新生成</span>
                        </button>
                        <button className="inline-flex items-center space-x-2 px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-xl transition-colors">
