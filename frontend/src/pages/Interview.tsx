                            ...
                            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                                ...
                                <div className="grid grid-cols-7 gap-1 mb-2">
                                    {daysOfWeek.map((day) => (
                                        <div
                                            key={day}
                                            className="text-center text-sm font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500 py-2"
                                        >
                                            {day}
                                        </div>
                                    ))}
                                            ...
                                            <button
                                                ...
                                                className={`relative p-2 rounded-lg text-center transition-colors ${
                                                    isToday
                                                        ...
                                                        : "hover:bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 dark:text-gray-600"
                                                }`}
                                            >
                                                        ...
                                                        {dayInterviews.slice(0, 3).map((_, idx) => (
                                                            <div
                                                                ...
                                                                className={`w-1 h-1 rounded-full ${
                                                                    isToday ? "bg-white" : "bg-blue-50 dark:bg-blue-900/200"
                                                                }`}
                                                            />
                                                        ))}
                                                    </div>
                                ...
                                <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-center justify-between text-sm">
                                            <span className="text-gray-500 dark:text-gray-400 dark:text-gray-500">今日面试</span>
                                            <span className="font-medium text-gray-900 dark:text-white">2 场</span>
                                        </div>
                                        <div className="flex items-center justify-between text-sm">
                                            <span className="text-gray-500 dark:text-gray-400 dark:text-gray-500">本周面试</span>
                                            <span className="font-medium text-gray-900 dark:text-white">5 场</span>
                                        </div>
                                        <div className="flex items-center justify-between text-sm">
                                            <span className="text-gray-500 dark:text-gray-400 dark:text-gray-500">待确认</span>
                                            <span className="font-medium text-amber-600 dark:text-amber-400">1 场</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="space-y-4">
                                {filteredInterviews.map((interview, index) => (
                                    <motion.div
                                        ...
                                        className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200 cursor-pointer"
                                        ...
                                        {interview.feedback && (
                                            <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                                                <div className="flex items-start space-x-2">
                                                    <MessageSquare className="w-4 h-4 text-gray-400 dark:text-gray-500 mt-0.5" />
                                                    <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 line-clamp-2">
                                                        {interview.feedback}
                                                    </p>
                                                </div>
                                                {interview.rating && (
                            ...
                            {filteredInterviews.length === 0 && (
                                <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-600">
                                    ...
                                    <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500">点击"安排面试"创建新的面试</p>
                                </div>
                            )}
                        </div>
                    </div>
                            ...
                            <div className="p-6">
                                <div className="flex items-center space-x-4 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500">{selectedInterview.position}</p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">面试时间</p>
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">面试时长</p>
                                            <p className="font-medium text-gray-900 dark:text-white">
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">面试方式</p>
                                            <p className="font-medium text-gray-900 dark:text-white">
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">面试官</p>
                                            <p className="font-medium text-gray-900 dark:text-white">
                                ...
                                {selectedInterview.feedback && (
                                    <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4">
                                        ...
                                        <p className="text-gray-600 dark:text-gray-400 dark:text-gray-500">{selectedInterview.feedback}</p>
                                        {selectedInterview.rating && (
                                            <div className="flex items-center space-x-1 mt-3">
                                                <span className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 mr-2">评分:</span>
                                                {Array.from({ length: 5 }, (_, i) => (
                                                    <Star
                                                        key={i}
                                                        className={`w-5 h-5 ${
